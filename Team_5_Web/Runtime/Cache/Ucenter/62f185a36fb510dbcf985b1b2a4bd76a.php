                    ...
                    <div class="panel admin-panel">
                        <div class="panel-head">
                            <form action="#" class="form-inline">
                                <div class="form-group">
                                    <div class="label"><label for="GPName">Search Proposal</label></div>
                                    <div class="field">
                                ...
                                &nbsp;
                                <div class="form-group">
                                    <div class="label"><label for="GPKey">keywords</label></div>
                                    <div class="field">
                                        <input type="text" class="input" id="GPKey" name="GPKey" size="12" value="<?php echo isset($seachData['GPKey']) && !empty($seachData['GPKey']) ? $seachData['GPKey'] : '';?>" placeholder="keywords" />
                                    </div>
                                </div>
                                &nbsp;
                                <div class="form-group">
                                    <div class="label"><label for="GPThrName">Supervised Professor</label></div>
                                    <div class="field">
                                ...
                                &nbsp;
                                <div class="form-group">
                                    <div class="label"><label for="GPState">Proposal Status</label></div>
                                    <div class="field">
                                ...
                                &nbsp;
                                <div class="form-group">
                                    <div class="label"><label for="GPSH">Proposal Direction</label></div>
                                    <div class="field">
                        ...
                        <table class="table table-hover table-striped table-bordered">
                            <tr>
                                ...
                                <th width="80">Proposal direction</th>
                                <th width="80">adviser</th>
        ...
        <div class="dialog"> 
            ...
            <div class="dialog-body">
                <div class="form-group form-group-me">
                    ...
                    <p>Project requirements：  <a class="gpRequest" href="#"></a></p>
                    <p>Essential knowledge：  <a class="gpMust" href="#"></a></p>
                    <p>Submission form：  <a class="gpFormal" href="#"></a></p>
                    ...
                    success: function(data){
                        if(data.state == true){
                            for(var x in data.detail){
                                if(x == 'gpSHState'){
                                    $(".dialog ." + x + "").html(data.detail[x] == 1 ? 'Software direction' : 'Hardware direction');
                                }else{
